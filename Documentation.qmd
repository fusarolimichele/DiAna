...
This way we standardize the route of administration, information about dechallenge and rechallenge, information about formulation and frequency of administration.

Information about doses needs a drug-specific standardization, since information about it is stored in multiple fields, and the unit is often dose-formulation. Information about lot number and nda number is also kept as it is, together with the exp_dt.
