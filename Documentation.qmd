...
Information about doses needs a drug-specific standardization, since information about it is stored in multiple fields, and the unit is often dose-formulation. Information about lot number and nda number is also kept as it is (and in the future may help to impute other fields), together with the exp_dt.
